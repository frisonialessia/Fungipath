...
export const NAV_ICONS: Record<string, ReactNode> = {
  ...
  community: <svg viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round"><circle cx="6.5" cy="6" r="2.4" /><circle cx="12.5" cy="7.5" r="2" /><path d="M2.5 15 C2.5 11.5 5 10.5 6.5 10.5 C8 10.5 10.5 11.5 10.5 15 M10.5 12.5 C11 11 12 10.8 12.8 10.8 C14 10.8 15.5 11.6 15.5 14.4" /></svg>,
